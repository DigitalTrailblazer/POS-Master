...
const StatCard = ({title, icon, number, footerNum}) => {
    return (
        <div className='py-5 px-5 rounded-lg w-[50%] bg-[#1a1a1a]'>
            
            <div className='flex items-start justify-between'>
                <h1 className='text-[#f5f5f5] text-lg font-semibold trackind-wide'>
                    {title}
                </h1>
